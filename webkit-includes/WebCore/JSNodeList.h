...
public:
    ...
    static JSNodeList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<NodeList>&& impl)
    {
        ...
        JSNodeList* ptr = new (NotNull, JSC::allocateCell<JSNodeList>(vm)) JSNodeList(structure, *globalObject, WTFMove(impl));
...
class JSNodeListOwner final : public JSC::WeakHandleOwner {
public:
