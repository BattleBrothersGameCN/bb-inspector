...
public:
    ...
    static JSNamedNodeMap* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<NamedNodeMap>&& impl)
    {
        ...
        JSNamedNodeMap* ptr = new (NotNull, JSC::allocateCell<JSNamedNodeMap>(vm)) JSNamedNodeMap(structure, *globalObject, WTFMove(impl));
...
class JSNamedNodeMapOwner final : public JSC::WeakHandleOwner {
public:
