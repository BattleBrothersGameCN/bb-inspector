...
public:
    ...
    static JSMediaList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MediaList>&& impl)
    {
        ...
        JSMediaList* ptr = new (NotNull, JSC::allocateCell<JSMediaList>(vm)) JSMediaList(structure, *globalObject, WTFMove(impl));
...
class JSMediaListOwner final : public JSC::WeakHandleOwner {
public:
