...
public:
    ...
    static JSHTMLCollection* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLCollection>&& impl)
    {
        ...
        JSHTMLCollection* ptr = new (NotNull, JSC::allocateCell<JSHTMLCollection>(vm)) JSHTMLCollection(structure, *globalObject, WTFMove(impl));
...
class JSHTMLCollectionOwner final : public JSC::WeakHandleOwner {
public:
