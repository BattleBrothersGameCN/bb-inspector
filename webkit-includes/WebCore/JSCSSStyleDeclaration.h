...
public:
    ...
    static JSCSSStyleDeclaration* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSStyleDeclaration>&& impl)
    {
        ...
        JSCSSStyleDeclaration* ptr = new (NotNull, JSC::allocateCell<JSCSSStyleDeclaration>(vm)) JSCSSStyleDeclaration(structure, *globalObject, WTFMove(impl));
...
class WEBCORE_EXPORT JSCSSStyleDeclarationOwner final : public JSC::WeakHandleOwner {
public:
