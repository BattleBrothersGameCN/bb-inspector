...
public:
    ...
    static JSStyleSheetList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<StyleSheetList>&& impl)
    {
        ...
        JSStyleSheetList* ptr = new (NotNull, JSC::allocateCell<JSStyleSheetList>(vm)) JSStyleSheetList(structure, *globalObject, WTFMove(impl));
...
class JSStyleSheetListOwner final : public JSC::WeakHandleOwner {
public:
