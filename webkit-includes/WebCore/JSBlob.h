...
public:
    ...
    static JSBlob* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<Blob>&& impl)
    {
        ...
        JSBlob* ptr = new (NotNull, JSC::allocateCell<JSBlob>(vm)) JSBlob(structure, *globalObject, WTFMove(impl));
    ...
    static WEBCORE_EXPORT Blob* toWrapped(JSC::VM&, JSC::JSValue);
...
class JSBlobOwner final : public JSC::WeakHandleOwner {
public:
