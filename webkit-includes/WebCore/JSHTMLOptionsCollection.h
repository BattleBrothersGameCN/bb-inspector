...
public:
    ...
    static JSHTMLOptionsCollection* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLOptionsCollection>&& impl)
    {
        ...
        JSHTMLOptionsCollection* ptr = new (NotNull, JSC::allocateCell<JSHTMLOptionsCollection>(vm)) JSHTMLOptionsCollection(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLOptionsCollection> protectedWrapped() const;
...
class JSHTMLOptionsCollectionOwner final : public JSC::WeakHandleOwner {
public:
