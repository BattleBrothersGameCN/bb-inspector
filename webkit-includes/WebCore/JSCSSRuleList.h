...
public:
    ...
    static JSCSSRuleList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSRuleList>&& impl)
    {
        ...
        JSCSSRuleList* ptr = new (NotNull, JSC::allocateCell<JSCSSRuleList>(vm)) JSCSSRuleList(structure, *globalObject, WTFMove(impl));
...
class JSCSSRuleListOwner final : public JSC::WeakHandleOwner {
public:
