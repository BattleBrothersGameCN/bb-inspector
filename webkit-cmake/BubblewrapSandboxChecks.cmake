if(ENABLE_BUBBLEWRAP_SANDBOX)
  ...
  if(NOT DEFINED BWRAP_EXECUTABLE)
    if(CMAKE_CROSSCOMPILING)
      message(
        FATAL_ERROR
          "bwrap executable version 0.3.1 or newer is needed for ENABLE_BUBBLEWRAP_SANDBOX. Unable to autodetect the path when cross-compiling. "
  ...
  if(NOT DEFINED DBUS_PROXY_EXECUTABLE)
    if(CMAKE_CROSSCOMPILING)
      message(
        FATAL_ERROR
          "xdg-dbus-proxy executable is needed for ENABLE_BUBBLEWRAP_SANDBOX.  Unable to autodetect the path when cross-compiling. "
      ...
      if(NOT DBUS_PROXY_EXECUTABLE)
        message(
          FATAL_ERROR
            "xdg-dbus-proxy executable not found and is needed for ENABLE_BUBBLEWRAP_SANDBOX. "
  ...
  if(NOT IS_ABSOLUTE "${DBUS_PROXY_EXECUTABLE}")
    message(
      FATAL_ERROR "The value for DBUS_PROXY_EXECUTABLE should be a full path.")
  endif()
  ...
  if(NOT CMAKE_CROSSCOMPILING)
    ...
    string(REGEX MATCH "[0-9]+\\.[0-9]+\\.[0-9]+" BWRAP_VERSION
                 "${BWRAP_OUTPUT}")
