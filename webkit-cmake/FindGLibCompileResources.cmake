...
function(GLIB_COMPILE_RESOURCES)
  ...
  cmake_parse_arguments(PARSE_ARGV 0 ARG "${zeroArgKeywords}"
                        "${oneArgKeywords}" "${manyArgsKeywords}")
  ...
  if(${glib_compile_resources_has_depfile_bug})
    ...
    #
    # Affected versions produce broken depfiles that look like this: foo.xml:
    # resource1 resource2 But depfiles should look like this: foo.c: foo.xml
    # resource1 resource2
    set(additional_cmd_line
        &&
        ${PERL_EXECUTABLE}
        -pi
        ${CMAKE_SOURCE_DIR}/Tools/glib/fix-glib-resources-depfile.pl
        ${ARG_SOURCE_XML}
        ${ARG_OUTPUT}
        ${ARG_OUTPUT}.deps)
  endif()
  ...
  add_custom_command(
    ...
    COMMAND
      ${GLIB_COMPILE_RESOURCES_EXECUTABLE} --generate --target=${ARG_OUTPUT}
      --dependency-file=${ARG_OUTPUT}.deps ${resource_dir_args}
      ${ARG_SOURCE_XML} ${additional_cmd_line}
