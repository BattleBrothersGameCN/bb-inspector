if(ENABLE_VIDEO OR ENABLE_WEB_AUDIO)
  ...
  if(PORT STREQUAL "WPE")
    ...
    if((NOT WPEBackendFDO_FOUND) OR (NOT WPEBackendFDO_AUDIO_EXTENSION))
      message(
        WARNING
          "WPEBackend-fdo audio extension not found. Disabling external audio rendering support"
      )
  ...
  if(USE_GSTREAMER_FULL)
    ...
    if(NOT PC_GSTREAMER_FULL_FOUND)
      message(
        FATAL_ERROR "GStreamer static library libgstreamer-full-1.0 not found")
    else()
    ...
    if(ENABLE_VIDEO)
      if(NOT PC_GSTREAMER_APP_FOUND
         OR NOT PC_GSTREAMER_PBUTILS_FOUND
         OR NOT PC_GSTREAMER_TAG_FOUND
         OR NOT PC_GSTREAMER_VIDEO_FOUND)
        message(
          FATAL_ERROR
            "Video playback requires the following GStreamer libraries: app, pbutils, tag, video. Please check your gst-plugins-base installation."
        )
      endif()
    endif()
    ...
    if(USE_GSTREAMER_MPEGTS AND NOT PC_GSTREAMER_MPEGTS_FOUND)
      message(
        FATAL_ERROR "GStreamer MPEG-TS is needed for USE_GSTREAMER_MPEGTS.")
    endif()
    ...
    if(ENABLE_MEDIA_RECORDER
       AND USE_GSTREAMER_TRANSCODER
       AND (NOT PC_GSTREAMER_TRANSCODER_FOUND OR PC_GSTREAMER_TRANSCODER_VERSION
                                                 VERSION_LESS "1.20"))
      message(
        FATAL_ERROR
    ...
    if(USE_GSTREAMER_WEBRTC AND (PC_GSTREAMER_VERSION VERSION_LESS "1.20"
                                 OR NOT PC_GSTREAMER_WEBRTC_FOUND))
      message(
        FATAL_ERROR
          "GStreamerWebRTC >= 1.20 is needed for USE_GSTREAMER_WEBRTC.")
    endif()
  endif()
endif()
