...
set(JavaScriptCore_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/JavaScriptCore/DerivedSources")
...
set(WebDriver_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/WebDriver/DerivedSources")
set(WebKitLegacy_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/WebKitLegacy/DerivedSources")
set(WebKit_DERIVED_SOURCES_DIR "${CMAKE_BINARY_DIR}/WebKit/DerivedSources")
set(WebInspectorUI_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/WebInspectorUI/DerivedSources")
set(MiniBrowser_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/MiniBrowser/DerivedSources")
set(TestRunnerShared_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/TestRunnerShared/DerivedSources")
set(DumpRenderTree_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/DumpRenderTree/DerivedSources")
set(WebKitTestRunner_DERIVED_SOURCES_DIR
    "${CMAKE_BINARY_DIR}/WebKitTestRunner/DerivedSources")
...
set(WebCore_PRIVATE_FRAMEWORK_HEADERS_DIR
    "${CMAKE_BINARY_DIR}/WebCore/PrivateHeaders")
set(WebKitLegacy_FRAMEWORK_HEADERS_DIR
    "${CMAKE_BINARY_DIR}/WebKitLegacy/Headers")
set(WebKit_FRAMEWORK_HEADERS_DIR "${CMAKE_BINARY_DIR}/WebKit/Headers")
set(WebKit_PRIVATE_FRAMEWORK_HEADERS_DIR
    "${CMAKE_BINARY_DIR}/WebKit/PrivateHeaders")
