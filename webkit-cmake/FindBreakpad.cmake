...
find_library(
  ...
  HINTS ${PC_BREAKPAD_LIBRARY_DIRS} ${PC_BREAKPAD_LIBDIR})

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Breakpad REQUIRED_VARS BREAKPAD_INCLUDE_DIRS
                                                         BREAKPAD_LIBRARY)
...
if(BREAKPAD_LIBRARY AND NOT TARGET Breakpad::Breakpad)
  ...
  set_target_properties(
    Breakpad::Breakpad
    PROPERTIES IMPORTED_LOCATION "${BREAKPAD_LIBRARY}"
